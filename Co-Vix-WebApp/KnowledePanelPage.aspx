<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KnowledePanelPage.aspx.cs" Inherits="Co_Vix_WebApp.KnowledePanelPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="topnav">
            ...
            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/RegisterPage.aspx">Register</asp:HyperLink>
            <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/KnowledePanelPage.aspx">Knowlade Panel</asp:HyperLink>
        ...
        <div style="margin-bottom: 450px">
            <div class="container">
                <asp:Label ID="Label1" runat="server" Text="Kwolegede Topic Title" CssClass="Text3"></asp:Label>
                <div>
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="Text2"></asp:TextBox>
            ...
            <div class="PB">
                ...
                <div style="margin-right: 50px; margin-left: 150px;">
                    ...
                    <h1 class="heading1">Knowlege Pnanel
                    </h1>
