<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainHomeSearchPage.aspx.cs" Inherits="Co_Vix_WebApp.MainHomeSearchPage" %>
        ...
        <div>
            ...
            <div class="PB">
                ...
                <div style="margin-right: 50px; margin-left: 150px;">
                    ...
                    <h1 class="heading1">Search Vaccinated Status
                    </h1>


                    <div style="margin-bottom: 10px; margin-top: 10px;">
                        <div style="margin-bottom: 30px; margin-top: 10px;">
                            <asp:TextBox ID="TextBox1" runat="server" CssClass="Text1"></asp:TextBox>
                            <asp:Button ID="Button7" runat="server" Text="Button" CssClass="button1" />
                        </div>

                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="UNICNo" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Horizontal" Width="479px">
                            <Columns>
                                <asp:BoundField DataField="UNICNo" HeaderText="UNICNo" ReadOnly="True" SortExpression="UNICNo" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DSProjectConnectionString %>" SelectCommand="SELECT [UNICNo], [Status] FROM [USERS]"></asp:SqlDataSource>
                    </div>
                </div>
            </div>
        </div>
