<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassUpdatePage.aspx.cs" Inherits="Co_Vix_WebApp.ForgetPassUpdatePage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div class="PB">
                ...
                <h1 class="heading">Forget Password
                ...
                <div style="margin-right: 50px; margin-bottom: 100px; margin-top: 50px;">
                    ...
                    <center>
                        ...
                        <div style="margin-bottom: 10px; margin-top: 10px;">
                            <asp:Label ID="Label3" runat="server" Text="NIC No" CssClass="label"></asp:Label>
                    ...
                    <div style="margin-bottom: 10px; margin-top: 10px;">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="button1" />
