<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgLogingPage.aspx.cs" Inherits="Co_Vix_WebApp.OrgLogingPage" %>
...
<body>
    <form id="form1" runat="server">
        <div class="topnav">
            ...
            <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/LogginHomePage.aspx">SignIn</asp:HyperLink>
            ...
            <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/AllBookingPage.aspx">Booking</asp:HyperLink>
