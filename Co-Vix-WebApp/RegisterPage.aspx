<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterPage.aspx.cs" Inherits="Co_Vix_WebApp.RegisterPage" %>
        ...
        <div>
            ...
            <div class="PB">
                ...
                <div style="margin-right: 50px; margin-left: 150px;">
                        ...
                        <h1 class="heading1">Registation For Organaization
                        </h1>
                    ...
                    <div style="margin-bottom: 10px; margin-top: 10px;">
                        <asp:Label ID="Label6" runat="server" Text="Address Line3" CssClass="label"></asp:Label>
                    ...
                    <div style="margin-bottom: 10px; margin-top: 25px;">
                        ...
                        <asp:Button ID="Button6" runat="server" Text="Button" CssClass="button1" />
